...
// const renderTable = (data:Country[], currPage:number) => {
...
//   const countriesToDisplay = data.slice(currPage * pageSize, (currPage + 1) * pageSize);
...
//       let filteredData = data.filter((country: Country) => country.name.toLowerCase().includes(nameValue.toLowerCase()));
//       filteredData = filteredData.filter((country: Country) => country.capital.toLowerCase().includes(capitalValue.toLowerCase()));
//       filteredData = filteredData.filter((country: Country) => country.currency.name.toLowerCase().includes(currencyValue.toLowerCase()));
//       filteredData = filteredData.filter((country: Country) => country.language.name.toLowerCase().includes(languageValue.toLowerCase()));
